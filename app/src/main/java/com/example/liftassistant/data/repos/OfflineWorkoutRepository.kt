...
class OfflineWorkoutRepository(private val workoutDao: WorkoutDao) : WorkoutRepository {
    ...
    override fun getInProgressWorkoutStream(): Flow<Workout?> =
        workoutDao.getInProgressWorkout()
    ...
    override suspend fun setEndTime(workoutId: Int, endTime: Date) =
        workoutDao.setEndTime(workoutId, endTime.time)
}